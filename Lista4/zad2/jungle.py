...
smarter_agent_score = big_score
sec_task_agent_score = small_score
big_score = 0
small_score = 0
...
for i in range(5):
    ...
    print("smarter agent score:", small_score + smarter_agent_score, ", zad2 agent score:", big_score + sec_task_agent_score)